...
Revision ID: 6af1e1ea2cb8
Revises:
Create Date: 2024-08-06 16:04:17.671701
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_tasks_collection_id"), "tasks", ["collection_id"], unique=False
    )
    op.create_index(op.f("ix_tasks_id"), "tasks", ["id"], unique=False)
    op.create_index(
        op.f("ix_tasks_is_important"), "tasks", ["is_important"], unique=False
    )
